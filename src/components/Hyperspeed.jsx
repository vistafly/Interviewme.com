  ...
  useEffect(() => {
    ...
    class App {
      constructor(container, options = {}) {
        ...
        // Guard against zero-size container (e.g. fade-in animation not yet painted)
        const initW = Math.max(container.offsetWidth, 1);
        const initH = Math.max(container.offsetHeight, 1);
    ...
    function resizeRendererToDisplaySize(renderer, setSize) {
      ...
      // Skip resize when dimensions are zero (container not yet laid out)
